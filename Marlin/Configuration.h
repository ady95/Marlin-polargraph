...
//#define CUSTOM_MACHINE_NAME "DrawGPT"
...
#define POLARGRAPH
  ...
  #define HYPOTENEUSE_LENGTH_AT_HOME_POSITION  600
...
#define MANUAL_Y_HOME_POS -256 //(Y_MAX_POS-( sqrt(sq(POLARGRAPH_MAX_BELT_LEN)-sq(X_BED_SIZE/2))))
